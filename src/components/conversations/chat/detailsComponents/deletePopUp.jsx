        ...
        <div className='w-[400px] flex items-center  flex-col p-3 h-[300px] absolute bg-black z-30  border border-midGray rounded-md'>
            <img onClick={()=> setDeleteShowing(false)} src="../close.svg" className=' flex self-end w-[20px] h-[20px] cursor-pointer' alt="" />
            {
            ...
            }
             {
                ...
                <h1 className='text-white text-[21px] my-8 text-center'>Are you sure you want to delete your account, This action is irreversible !</h1>
            }
            {
               deleteAction == "delete" &&
            ...
            }
            {
               ...
               {
                deleteAction =="account" &&
                <DangerButton loading={deleteAccountLoading} onClick={()=>{deleteAccount()}} text={"Delete Account"}/>
            }
