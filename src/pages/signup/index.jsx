...
const Signup = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (confirmPassword !== password)
      validatorObject.confirmPassword = "Confirm Password must match password";
    if (error) {
  ...
  return (
    <main className="mainGradient w-screen h-screen flex flex-row items-center">
      <motion.div
        ...
        className={` lg:w-[50%] w-full h-full flex flex-col p-4 items-center justify-center`}
      >
        <h1 className="text-[42px] text-white font-bold">Create account</h1>
        <p className="text-mainGray mb-[50px]">
        ...
        <form
          ...
          className="flex lg:w-[50%] w-[80%] flex-col items-center gap-[50px] mb-[50px]"
          action=""
        >
