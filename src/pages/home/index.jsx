...
const Home = () => {
  ...
  return (
    <div className=" scroll-smooth">
      <nav
        className={`border-b-2  w-screen  bg-[#1d1438] z-30 fixed  border-black h-[70px] flex flex-row items-center justify-between p-3`}
      >
      ...
      <div className="w-screen overflow-hidden pt-[70px] flex flex-col items-center mainGradient  min-h-screen">
        <motion.div
          initial={{ opacity: 0, scale: 0.8 }}
          transition={{ duration: 0.3 }}
          animate={{ opacity: 1, scale: 1 }}
          className="flex flex-col p-4 my-[100px]   justify-center items-start   gap-y-4 "
        >
          ...
          <button
            onClick={() => navigate("/signup")}
            className="w-[200px] bg-tekhelet rounded-[20px] h-[50px] text-white text-[18px] hover:scale-110 transition-[2000ms]"
          >
            Get Started
          </button>
        </motion.div>
        ...
        <div className="lg:w-[50%] w-full">
          {info.map((inf, index) => (
            <section
              data-aos="fade-up"
              className={`w-full mb-[70px] p-4 l flex  ${
            ...
            >
              <div className="lg:w-[50%] flex flex-col gap-2 w-full">
                ...
                <h1 className="text-tekhelet font-semibold ">
                  {inf.firstHeader}
                </h1>
